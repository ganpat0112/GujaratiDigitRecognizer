...
class DrawingCanvas:
    def __init__(self, canvas):
        self.canvas = canvas
        self.image = Image.new("L", (28, 28), "white")  # Create a blank white image
...
def predict_from_canvas():
    digit, confidence = predict_digit(drawing_canvas.image)
...
# Canvas for drawing
canvas_widget = tk.Canvas(root, width=28, height=28, bg="white")
