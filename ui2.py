...
def predict_from_canvas():
    canvas_image = Image.new("RGB", (28, 28), "white")
    canvas.postscript(file="canvas_image.eps")
    canvas_image = Image.open("canvas_image.eps")
...
# Canvas for drawing
canvas = tk.Canvas(root, width=28, height=28, bg="white")
